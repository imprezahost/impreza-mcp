...
try {
 ...
 const input={name:'node-fixture',agent_id:'agt_fixture',mode:'dockerfile',git_url:'https://github.com/example/app.git',build_strategy:'node_npm_static',target_port:8080,static_output_dir:'public/site',static_spa:false};
